...
//  Strings
//
//  Created by Jeffrey Almonte on 10/9/18.
//  Copyright © 2018 Jeffrey Almonte. All rights reserved.
//

import Foundation

//String is a collection a of characters
...
emptyString.isEmpty ? print("is empty") : print("NOT - using ternary operator empty"); print("NOT empty - using teranry operator")

// alternate using if/else
if emptyString { // built in function
...
print("I hve \(stringExperience) in coding")
...
for letter in iOS { // using a for loop to print out every character of iOS string
    ...
    print(letter, separator: "|", terminator:"") // does not defualt to a new line
...
// drop the last character in s string
print("droping the last character \(iOS.dropLast())")
